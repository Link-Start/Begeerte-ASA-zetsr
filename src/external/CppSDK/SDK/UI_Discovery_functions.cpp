...
void UUI_Discovery_C::CustomEvent_0(const struct FModsHighlightsV2& mods)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_Discovery_C", "CustomEvent_0");

	Params::UI_Discovery_C_CustomEvent_0 Parms{};
