...
void UMapMarkerSettingsWidget_ASA_C::HasLimitedWaypoints(bool Get_First_Unclaimed_Default_Number, int32* Num, bool* Max, int32* First_Unclaimed_Default_Number)
{
	static class UFunction* Func = nullptr;
