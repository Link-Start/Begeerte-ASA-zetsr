...
public:
	...
	class USphereComponent*                       StasisComponent;                                   // 0x2A88(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	TArray<class UAnimSequence*>                  AlternateDeathAnims;                               // 0x2A90(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FDinoContentData                       ContentData;                                       // 0x2AA0(0x0020)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          GeneratedBlendSpaces;                              // 0x2AC0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_2AC1[0x7];                                     // 0x2AC1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        PostDestructionFootstepLifespan;                   // 0x2AC8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          SupportsConsumablesAutoTransfer;                   // 0x2AD0(0x0001)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, ExperimentalAlwaysOverriden)
	uint8                                         Pad_2AD1[0x7];                                     // 0x2AD1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   HarnesSaddleItem;                                  // 0x2AD8(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	double                                        CartBodyPitchOffset;                               // 0x2B00(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                   DisableConsumablesTransferText;                    // 0x2B08(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                   EnableConsumablesTransferText;                     // 0x2B18(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
