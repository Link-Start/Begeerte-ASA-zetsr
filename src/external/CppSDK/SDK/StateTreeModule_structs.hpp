...
public:
	...
	uint8                                         Pad_7[0x9];                                        // 0x0007(0x0009)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FStateTreePropertyIndirection          SourceIndirection;                                 // 0x0000(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FStateTreePropertyIndirection          TargetIndirection;                                 // 0x0010(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_20[0x10];                                      // 0x0020(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CopySize;                                          // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      SourceStructIndex;                                 // 0x0034(0x0002)(NoDestructor, NativeAccessSpecifierPublic)
	EStateTreePropertyCopyType                    Type;                                              // 0x0036(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<struct FStateTreePropertySegment>      PropertySegments;                                  // 0x0030(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FStateTreePropCopy>             PropertyCopies;                                    // 0x0040(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<struct FStateTreePropertyIndirection>  PropertyIndirections;                              // 0x0050(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	EStateTreeStateType                           Type;                                              // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasTransitionTasks : 1;                           // 0x001E(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
