...
public:
	...
	TMulticastInlineDelegate<void(class USpawnRegionWidget_ASA_C* SpawnRegion)> Clicked;             // 0x0370(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
