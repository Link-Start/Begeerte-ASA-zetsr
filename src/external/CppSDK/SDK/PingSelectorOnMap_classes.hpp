...
public:
	...
	TMulticastInlineDelegate<void(ETeamPingType PingType)> CallPing;                                 // 0x0388(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
