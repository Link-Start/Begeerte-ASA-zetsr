...
public:
	...
	struct FUseItemAddCharacterStatusValue        K2Node_MakeStruct_UseItemAddCharacterStatusValue;  // 0x0020(0x0060)()
	...
	class UDinoSettings_Base_C*                   K2Node_DynamicCast_AsDino_Settings_Base;           // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FDinoFoodEffectivenessMultipliers      CallFunc_Array_Get_Item;                           // 0x00B0(0x0030)(NoDestructor)
