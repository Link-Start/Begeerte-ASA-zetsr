...
// Parameters:
// TArray<int64>&                          IDsOfOwnedMods                                         (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UUI_GameSlot_C::UpdatePaidPremiumStatus(TArray<int64>& IDsOfOwnedMods)
{
	static class UFunction* Func = nullptr;
	...
	Params::UI_GameSlot_C_UpdatePaidPremiumStatus Parms{};

	Parms.IDsOfOwnedMods = std::move(IDsOfOwnedMods);

	UObject::ProcessEvent(Func, &Parms);

	IDsOfOwnedMods = std::move(Parms.IDsOfOwnedMods);
}
...
void UUI_GameSlot_C::Try_Set_Game_Version()
{
	static class UFunction* Func = nullptr;
...
void UUI_GameSlot_C::OnSuccess_9D95364741CA1B5428249F8ACB4C6143(class UTexture2DDynamic* Texture)
{
	...
	Params::UI_GameSlot_C_OnSuccess_9D95364741CA1B5428249F8ACB4C6143 Parms{};
...
void UUI_GameSlot_C::OnFail_9D95364741CA1B5428249F8ACB4C6143(class UTexture2DDynamic* Texture)
{
	...
	Params::UI_GameSlot_C_OnFail_9D95364741CA1B5428249F8ACB4C6143 Parms{};
...
// Function UI_GameSlot.UI_GameSlot_C.IndividualDownloadImage
// (BlueprintCallable, BlueprintEvent)

void UUI_GameSlot_C::IndividualDownloadImage()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UI_GameSlot_C", "IndividualDownloadImage");
...
void UUI_GameSlot_C::CustomEvent_1(const struct FCFCoreError& Error)
{
	...
	Params::UI_GameSlot_C_CustomEvent_1 Parms{};
...
void UUI_GameSlot_C::CustomEvent(const struct FModsDirInfo& ModsDirInfo)
{
	...
	Params::UI_GameSlot_C_CustomEvent Parms{};
...
void UUI_GameSlot_C::ClearAllModsInAllPages()
{
	static class UFunction* Func = nullptr;
