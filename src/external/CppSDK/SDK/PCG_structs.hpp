...
{
public:
	struct FSoftISMComponentDescriptor            Descriptor;                                        // 0x0000(0x01E8)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTransform>                     Instances;                                         // 0x01E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int64>                                 InstancesMetadataEntry;                            // 0x01F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	struct FSoftISMComponentDescriptor            Descriptor;                                        // 0x0000(0x01E8)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Weight;                                            // 0x01E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
