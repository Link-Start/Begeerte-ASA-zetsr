...
public:
	...
	class UOptionSelector_Widget_C*               K2Node_DynamicCast_AsOption_Selector_Widget;       // 0x0078(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
