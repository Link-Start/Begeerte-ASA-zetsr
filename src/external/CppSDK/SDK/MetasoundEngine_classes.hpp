...
public:
	...
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x06F0(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0740(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x0790(0x0050)(Protected, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_7F4[0x6C];                                     // 0x07F4(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
