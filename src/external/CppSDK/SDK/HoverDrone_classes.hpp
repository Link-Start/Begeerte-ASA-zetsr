...
public:
	...
	int32                                         MaxAllowedSpeedIndex;                              // 0x01A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AC[0x4];                                      // 0x01AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              MaxAllowedSpeedUpdated;                            // 0x01B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_280[0x170];                                    // 0x0280(0x0170)(Fixing Size After Last Property [ Dumper-7 ])
	...
	int32                                         DroneSpeedParamIndex;                              // 0x0434(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_46C[0x3C];                                     // 0x046C(0x003C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         bSimulateRotation : 1;                             // 0x04AC(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bIgnoreDroneLimiters : 1;                          // 0x04AC(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_4AD[0x33];                                     // 0x04AD(0x0033)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4E4[0x6C];                                     // 0x04E4(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UCameraComponent*                       CameraComponent;                                   // 0x05B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	bool                                          bIsTiltingEnabled;                                 // 0x05B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowSpeedChange;                                 // 0x05B9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bConstrainMovementToXYPlane;                       // 0x05BA(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_5BB[0x5];                                      // 0x05BB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIIRInterpolatorRotator                DroneTiltInterpolator;                             // 0x05C0(0x0078)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FVector                                TiltUpVector;                                      // 0x0638(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableTiltLimits;                                 // 0x0650(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_651[0x7];                                      // 0x0651(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRotator                               TiltLimits;                                        // 0x0658(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_670[0x18];                                     // 0x0670(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	int32                                         MaxAllowedSpeedIndex;                              // 0x0518(0x0004)(Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TSet<class AHoverDroneSpeedLimitBox*>         SpeedLimitBoxes;                                   // 0x0030(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	TSet<class ABlockingVolume*>                  BlockingVolumes;                                   // 0x0080(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
