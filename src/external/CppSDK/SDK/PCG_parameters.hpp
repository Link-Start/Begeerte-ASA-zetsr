...
{
public:
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x0000(0x0208)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	const class UPCGMetadata*                     MetaData;                                          // 0x0208(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           AttributeNames;                                    // 0x0210(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x0220(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPCGMeshInstanceList                   InstanceList;                                      // 0x00A0(0x0208)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FPCGPackedCustomData                   OutPackedCustomData;                               // 0x02A8(0x0018)(Parm, OutParm, NativeAccessSpecifierPublic)
};
