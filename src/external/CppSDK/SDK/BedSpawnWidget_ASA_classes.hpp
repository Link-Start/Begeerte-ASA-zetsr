...
public:
	...
	TMulticastInlineDelegate<void(class UBedSpawnWidget_ASA_C* BedSpawn)> Clicked;                   // 0x0380(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	int32                                         SpawnID;                                           // 0x0394(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<int32>                                 AverageBeds;                                       // 0x03C0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
