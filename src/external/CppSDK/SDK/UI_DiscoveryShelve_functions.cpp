...
// Parameters:
// const TArray<int64>&                    ListOfMods                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UUI_DiscoveryShelve_C::Create(const TArray<int64>& ListOfMods)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ListOfMods = std::move(ListOfMods);
