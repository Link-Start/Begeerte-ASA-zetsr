...
{
public:
	struct FConcertSequencerState                 State;                                             // 0x0000(0x0040)(NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FConcertSerializedPropertyData> PropertyDatas;                                     // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 SerializedAnnotationData;                          // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
