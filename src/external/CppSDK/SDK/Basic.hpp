...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0C3FC1D0;
	constexpr int32 AppendString      = 0x01675D80;
	constexpr int32 GetNameEntry      = 0x01676AB0;
	constexpr int32 GNames            = 0x0C797580;
	constexpr int32 GWorld            = 0x0C75DF08;
	constexpr int32 ProcessEvent      = 0x018C2240;
