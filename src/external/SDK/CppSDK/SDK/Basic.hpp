...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E11F180;
	constexpr int32 AppendString      = 0x01669870;
	constexpr int32 GetNameEntry      = 0x0166A5A0;
	constexpr int32 GNames            = 0x0E4A2940;
	constexpr int32 GWorld            = 0x0E46A238;
	constexpr int32 ProcessEvent      = 0x01925A70;
